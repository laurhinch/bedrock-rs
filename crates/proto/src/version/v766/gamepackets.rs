use crate::v766::packets::{
    AddActorPacket, AddItemActorPacket, AddPlayerPacket, AwardAchievementPacket, BossEventPacket, CameraAimAssistPacket, CameraAimAssistPresetsPacket, CameraInstructionPacket,
    CameraPresetsPacket, ChangeDimensionPacket, ClientBoundCloseFormPacket, ClientBoundDebugRendererPacket,
    ClientBoundMapItemDataPacket, CodeBuilderSourcePacket, ContainerClosePacket, ContainerRegistryCleanupPacket, CorrectPlayerMovePredictionPacket,
    CraftingDataPacket, DisconnectPacket, EditorNetworkPacket, EmotePacket, InventoryContentPacket,
    InventorySlotPacket, ItemStackRequestPacket, ItemStackResponsePacket, JigsawStructureDataPacket,
    LegacyTelemetryEventPacket, MobArmorEquipmentPacket, PlayerActionPacket,
    PlayerArmorDamagePacket, PlayerAuthInputPacket, PlayerListPacket, ResourcePackStackPacket,
    ResourcePacksInfoPacket, ServerBoundDiagnosticsPacket, ServerBoundLoadingScreenPacket, SetActorDataPacket, SetActorLinkPacket, SetMovementAuthorityPacket, SetTitlePacket,
