use crate::version::v662::packets::{
    ...
    ClientboundMapItemDataPacket, CodeBuilderPacket, CommandBlockUpdatePacket, CommandOutputPacket,
    ...
    CreativeContentPacket, DeathInfoPacket, DebugInfoPacket, DimensionDataPacket, DisconnectPacket,
    EditorNetworkPacket, EduUriResourcePacket, EducationSettingsPacket, EmoteListPacket,
    EmotePacket, FeatureRegistryPacket, GameRulesChangedPacket, GameTestRequestPacket,
    GameTestResultsPacket, GuiDataPickItemPacket, HurtArmorPacket, InteractPacket,
    InventoryContentPacket, InventorySlotPacket, InventoryTransactionPacket, ItemComponentPacket,
    ItemStackRequestPacket, ItemStackResponsePacket, LabTablePacket, LecternUpdatePacket,
